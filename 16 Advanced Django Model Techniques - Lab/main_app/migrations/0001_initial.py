    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.DecimalField(decimal_places=2, max_digits=3, validators=[django.core.validators.MinValueValidator(0.0, message='Rating must be at least 0.00.'), django.core.validators.MaxValueValidator(5, message='Rating cannot exceed 5.00.')])),
            ],
        ),
        migrations.CreateModel(
            name='Menu',
